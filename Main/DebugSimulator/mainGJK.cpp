...
int main(int argc,char** argv) {
  ...
  A->init<double>({
    Eigen::Matrix<double,3,1>(10,10,-1),
    Eigen::Matrix<double,3,1>(-70,10,-1),
    Eigen::Matrix<double,3,1>(-70,10,-1000)},
  {Eigen::Matrix<int,3,1>(0,1,2)},false);
  std::shared_ptr<MeshExact> B(new MeshExact);
  B->init<double>({
    Eigen::Matrix<double,3,1>(-0.590453,-0.0301511,0.0301511),
    Eigen::Matrix<double,3,1>(-0.568825,-0.0688247,0.0229416),
    Eigen::Matrix<double,3,1>(-0.568825,-0.0688247,-0.0229416)}, {Eigen::Matrix<int,3,1>(0,1,2)},false);
