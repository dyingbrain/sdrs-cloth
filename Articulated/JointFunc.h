...
struct JointFunc {
  ...
  static void DDT(const Joint& J,std::function<void(int,int,T)> hess,Mat3XTCM DDT,const Vec3T& coefRss);
  static void DDT(const Joint& J,MatTM hess,Mat3XTCM DDT,const Vec3T& coefRss);
  static Vec3T DDT(const Joint& J,Mat3XTCM DDT,int R,int C);
